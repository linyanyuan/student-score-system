...
assert.match(source, /navigate\('\/classes'\)/, 'Home should link quick entry to /classes')
assert.match(source, /navigate\('\/subjects'\)/, 'Home should link quick entry to /subjects')
assert.match(source, /navigate\('\/exams'\)/, 'Home should link quick entry to /exams')
assert.match(source, /navigate\('\/schedule-manage'\)/, 'Home should keep quick entry to /schedule-manage')
assert.doesNotMatch(source, /navigate\('\/class-manage'\)/, 'Home should not link quick entry to /class-manage')
assert.doesNotMatch(source, /navigate\('\/subject-manage'\)/, 'Home should not link quick entry to /subject-manage')
assert.doesNotMatch(source, /navigate\('\/exam-manage'\)/, 'Home should not link quick entry to /exam-manage')
